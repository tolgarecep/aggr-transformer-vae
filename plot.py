...
if __name__ == '__main__':
    ...
    save_dir = "plot_figure/multiple"

    if not os.path.exists(save_dir):
        os.makedirs(save_dir)

    data_path = './model/space%d.pickle' % (args.iter)
    save_path = './model/plot_space%d.pdf' % (args.iter)

    data_path = './model/space0.pickle'
    save_path = './model/plot0.pdf'
